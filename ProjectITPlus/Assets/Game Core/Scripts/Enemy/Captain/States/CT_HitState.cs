...
public class CT_HitState : CT_State {
    private float timeToCheck = .15f;

    private bool isDetectedGround;

    #region Constructor
    public CT_HitState(CT_Controller controller, CT_Data data, int hashParam, bool isTriggerParam) : base(controller, data, hashParam, isTriggerParam) {
    }
    #endregion
