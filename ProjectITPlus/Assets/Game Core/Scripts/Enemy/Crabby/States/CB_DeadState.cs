...
public class CB_DeadState : CB_State {
    ...
    #region Constructor
    public CB_DeadState(CB_Controller controller, CB_Data data, int hashParam, bool isTriggerParam) : base(controller, data, hashParam, isTriggerParam) {
    }
    #endregion
