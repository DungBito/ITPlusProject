...
public class CB_IdleState : CB_State {
    ...
    #region Constructor
    public CB_IdleState(CB_Controller controller, CB_Data data, int hashParam, bool isTriggerParam) : base(controller, data, hashParam, isTriggerParam) {
