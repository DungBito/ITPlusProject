...
public class CB_AttackState : CB_State {
    private float delayAttackTime;

    #region Constructor
    public CB_AttackState(CB_Controller controller, CB_Data data, int hashParam, bool isTriggerParam) : base(controller, data, hashParam, isTriggerParam) {
